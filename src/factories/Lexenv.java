...
public abstract class Lexenv {
	...
	/***
	 * Initialisation de l'environnement lexical avec notamment les mots du langage
	 * C
	 */
	...
	/***
	 * Renvoie un nouveau nom, pas encore utilisé
	 * 
	 * @return String nom
	 */
	...
	/***
	 * _Si True, les appels a getNewName renverront des noms sous la forme
	 * error_XXXX
	 * 
	 * @param b
	 */
