...
public class ASTBoolOperation extends ASTExpr {
	...
	/***
	 * Cas d'une Opération booleenne où on aurait la partie gauche, droite, ainsi
	 * que le signe (== par défault si non correct). Non utilisé
	 * 
	 * @param type
	 * @param nom
	 * @param valeur
	...
	/***
	 * Cas d'une opératon booléenne a laquelle on ne donnerais qu'un booléen, et
	 * qui s'occupe aléatoirement de créer un ast cohérent
	 * 
	 * @param type
	 * @param nom
	 * @param valeur
