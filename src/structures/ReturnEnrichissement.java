...
public class ReturnEnrichissement {
	...
	/***
	 * Renvoie la liste des variables déclarées dans la liste des AST a rajouter avant
	...
	/***
	 * Renvoie la liste des variables déclarées dans la liste des AST a rajouter après
	 * @return ArrayList String des noms des variables
	 */
